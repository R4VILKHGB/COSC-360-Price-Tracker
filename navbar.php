...
//            if(isset($_SESSION["currentUser"])) {
                echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"wishlist.php\">My Wishlist</a></li>";
                echo "<li class=\"nav-item\"><a class=\"nav-link\" href=\"user_dashboard.php\">Dashboard</a></li>";
//            }
            ?>
        </ul>
        ...
        <?php
        if(isset($_SESSION["currentUser"])) {
            echo "<span>Welcome, " . $_SESSION["currentUser"];
            if(isset($_SESSION["acctType"]) && $_SESSION["acctType"] == 1) {
                echo " (Administrator)";
            }
            echo "</span>";
